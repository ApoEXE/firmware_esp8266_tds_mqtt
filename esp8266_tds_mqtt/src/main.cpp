...
void loop()
{
  ...
  else
  {
    ...
    if (millis() - printTimepoint > 800U)
    {
      ...
      tdsValue = 10 * (133.42 * compensationVolatge * compensationVolatge * compensationVolatge - 255.86 * compensationVolatge * compensationVolatge + 857.39 * compensationVolatge) * 0.5; // convert voltage value to tds value
